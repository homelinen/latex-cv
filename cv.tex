...
\begin{itemize}
    ...
    \begin{itemize}
        \item \textbf{Dissertation} Currently working on moving an Android
        ...
        \item Three courses of note:
            \begin{itemize}
                ...
                \item \textbf{Software Engineering} \\
                    ...
                    third year. Discusses \emph{source control}, \emph{The MVC Pattern}
                    and other aspects of software engineering. 
                    The project was to deliver a sport tournament application.
                    As part of a team of 6, we created a Ruby on Rails
...
\begin{itemize}
    ...
    \item Programming with Ruby and Google Apps Script for applications at Cloudreach Limited.
    \end{itemize}
\end{itemize}
