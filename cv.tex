...
\begin{itemize}
    ...
    \begin{itemize}
      ...
      \item Configuration and troubleshooting experience for various web platforms, including
          Apache, Nginx, IIS, MSSQL and MySQL servers.
      \item Maintaining medium to large AWS estates running Ubuntu, Redhat and Windows operating
        systems.
      \item Programming with Ruby and Google Apps Script for various in-house solutions and monitoring.
      \item Use of the Scrum methodology in application development
      \item Deploying applications with Chef, modifying and extending Chef configurations and the
